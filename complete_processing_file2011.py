...
pdffileobj = open('processed_dataset/ESHG2011Abstracts.pdf', 'rb') 
# -
...
for i in range(x):
   ...
   # Append-adds at last
   file1 = open("processed_dataset_text/ESHG20111Abstracts.txt", "a", encoding='utf-8')  # append mode
   file1.write(text)
   file1.close()
...
file1 = open("processed_dataset_text/ESHG20111Abstracts.txt", "r", encoding='latin-1')
