...
pdffileobj = open('processed_dataset/ESHG2013Abstracts.pdf', 'rb') 
# -
...
for i in range(x):
   ...
   # Append-adds at last
   file1 = open("processed_dataset_text/ESHG2013Abstracts.txt", "a", encoding='utf-8')  # append mode
   file1.write(text)
   file1.close()
...
file1 = open("processed_dataset_text/ESHG2013Abstracts.txt", "r",  encoding='utf-8')
...
#df2 = df2.dropna() only for checking why S03.1 is being deleted
...
df2= df2.dropna() #comment for now to keep S03.1
