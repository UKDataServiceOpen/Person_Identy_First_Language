...
pdffileobj = open('processed_dataset/ESHG2007Abstracts.pdf', 'rb') 
# -
...
for i in range(x):
   ...
   # Append-adds at last
   file1 = open("processed_dataset_text/ESHG2007Abstracts.txt", "a", encoding='utf-8')  # append mode
   file1.write(text)
   file1.close()
...
file1 = open("processed_dataset_text/ESHG2007Abstracts.txt", "r", encoding='latin-1')
...
df3.to_csv('results/ESHG2007Abstracts.csv', index = False)  
